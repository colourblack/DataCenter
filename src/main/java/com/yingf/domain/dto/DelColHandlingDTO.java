...
import com.yingf.domain.query.clean.DelColHandlingQuery;
 ...
 *              批量删除字段, 用于向python端发送清洗任务信息
 * @since 5/8/21 3:44 PM
 */
@ApiModel(value = "AddColHandlingDTO", description = "批量删除字段 - DTO")
public class DelColHandlingDTO extends DelColHandlingQuery {
