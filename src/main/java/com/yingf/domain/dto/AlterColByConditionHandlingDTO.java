...
import com.yingf.domain.query.clean.AlterColByConditionHandlingQuery;
 ...
 */
@ApiModel(value = "AlterColByConditionHandlingDTO", description = "根据给定条件修改字段 - DTO")
public class AlterColByConditionHandlingDTO extends AlterColByConditionHandlingQuery {
