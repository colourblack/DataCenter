...
import com.yingf.exception.CustomException;
...
public class SecurityUtil {
    ...
    public static String getUsername() {
        try {
            ...
            throw new CustomException("获取用户账户异常", HttpStatus.AUTH_ERROR);
        }
    }
    ...
    public static LoginUserDetails getLoginUser() {
        try {
            ...
            throw new CustomException("获取用户信息异常", HttpStatus.AUTH_ERROR);
        }
    }
